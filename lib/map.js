...
var IconPresets = {markerSet: 'open-freight', mapMarker: 'circle-sm', legendMarker:'circle-md', iconSet: 'dynico'};
...
var commicon = L.OpenFreightMarkers.icon({
    ...
    pipeIcon = L.OpenFreightMarkers.icon({
        icon: 'pipeline', markerColor: 'yellow', layer:'pipelines', title: 'Pipeline'}, IconPresets);
