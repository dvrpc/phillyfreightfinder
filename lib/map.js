...
var IconPresets = {iconSet: 'open-freight', className: 'circle-cm'};


var commicon = L.OpenFreightMarkers.icon({
        icon: 'airport', markerColor: 'forest'}, IconPresets),
    relvicon = new L.OpenFreightMarkers.icon({
        icon: 'airport', markerColor: 'green'}, IconPresets),
    helicon = L.OpenFreightMarkers.icon({
        icon: 'heliport', markerColor: 'ltgreen'}, IconPresets),
    FCintericon = L.OpenFreightMarkers.icon({
        icon: 'center', markerColor: 'peach'}, IconPresets),
    FCmajoricon = L.OpenFreightMarkers.icon({
        icon: 'center', markerColor: 'orange'}, IconPresets),
    FCmegaicon = L.OpenFreightMarkers.icon({
        icon: 'center', markerColor: 'red'}, IconPresets),
    trckprkicon = L.OpenFreightMarkers.icon({
        icon: 'parking', markerColor: 'purple'}, IconPresets),
    hwybricon = L.OpenFreightMarkers.icon({
        icon: 'bridge', markerColor: 'purple'}, IconPresets),
    NHSicon = L.OpenFreightMarkers.icon({
        icon: 'nhs', markerColor: 'purple'}, IconPresets),
    ryicon = L.OpenFreightMarkers.icon({
        icon: 'railyard', markerColor: 'gold'}, IconPresets),
    imicon = L.OpenFreightMarkers.icon({
        icon: 'intermodal', markerColor: 'gold'}, IconPresets),
    xingicon = L.OpenFreightMarkers.icon({
        icon: 'railxing', markerColor: 'gold'}, IconPresets),
    rbicon = L.OpenFreightMarkers.icon({
        icon: 'bridge', markerColor: 'gold'}, IconPresets),
    prticon = L.OpenFreightMarkers.icon({
        icon: 'ship', markerColor: 'blue'}, IconPresets),
    anchicon = L.OpenFreightMarkers.icon({
        icon: 'anchor', markerColor: 'blue'}, IconPresets),
    fgnicon = L.OpenFreightMarkers.icon({
        icon: 'community', markerColor: 'teal'}, IconPresets);
...
map.addLayer(railbridge);
map.addLayer(fgneighbor);
