...
//county data controls and functions
            ...
            function populateCounty(e) {
                ...
                $('#countyBoundsLink').html('<a href="#map" onClick="map.invalidateSize();zoomToCounty('+countyBounds._southWest.lat+', '+countyBounds._southWest.lng+', '+countyBounds._northEast.lat+', '+countyBounds._northEast.lng+');"><button class="btn btn-primary" ><i class="dynico dynico-map"></i>&nbsp;&nbsp;Browse by Map</button></a>');
