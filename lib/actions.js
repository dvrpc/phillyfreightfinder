...
//county data controls and functions
            ...
            function populateCounty(e) {
                ...
                $('#countyBoundsLink').html('<a href="#" onClick="mapView();zoomToCounty('+ countyBounds +')"><button class="btn btn-primary" ><i class="dynico dynico-map"></i>&nbsp;&nbsp;Browse by Map</button></a>');
