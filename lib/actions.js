...
var dataID, dwnID, dwnName, dwnFile, dwnDate; 
    console.log('pre');
    /*$.getJSON( "http://dvrpcfreight.github.io/phillyfreightfinder/data/download/dataUpdates.js")
      .done(function( data ) {
        console.log( "Success");
      })
