...
//county data controls and functions
            ...
            function populateCounty(e) {
                ...
                var slideshow = "<ul class='bxslider'><li><img src='lib/images/county/"+ props.NAME +"/1.jpg'  title='"+props.one+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/2.jpg' title='"+props.two+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/3.jpg' title='"+props.three+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/4.jpg' title='"+props.four+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/5.jpg' title='"+props.five+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/6.jpg' title='"+props.six+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/7.jpg' title='"+props.seven+"' /></li>"
                		+"<li><img src='lib/images/county/"+ props.NAME +"/8.jpg' title='"+props.eight+"' /></li></ul>";
                ...
                var mcountyPrint = ({name: name, 1: data1, 2: data2, 3: data3, 4:data4, 5:data5, 6:data6, 7:data7, 8:data8, 9:data9, 10:data10, 11:data11, 12:data12,13:data13,14:data14,15:data15,16:photo,17:caption});
                            
                var mcLink = 'modals/mcountyPrint.html?'+ serialize(mcountyPrint)
                //console.log(mcLink);
                $('#countyBtn').html('<a href="'+ mcLink +'" target="_blank"><button class="btn btn-primary" ><i class="PFFicon-compass"></i>&nbsp;&nbsp;Print Version</button></a>');
...
$(document).ready(function() {
    ...
    // Create the chart
       /* ValueChart = new Highcharts.Chart({
            chart: {
