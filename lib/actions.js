   ...
   */
    ...
    $.getJSON("http://dvrpcfreight.github.io/phillyfreightfinder/data/download/dataUpdates.json", function(data) {
        ...
        for(var i = 0; i < data.length; i++){
            ...
            $('#dataDwnld-' + dwnID).append('<div class="right"><p>Last Update: '+ dwnDate +'</p><a href="http://dvrpcfreight.github.io/phillyfreightfinder/data/download/'+ dwnFile + '.zip">Download Shapefile</a></div>' );
        }
    });
