...
var sm={};sm.packer=function(){var t={},r=0,a=[],n=[],e=[];t.elements=function(r){return arguments.length?(e=r,t):e},t.animating=!1,t.start=function(){a=[];for(var s=0;s<e.length;s++){var l=e[s].getAttribute("transform"),u=l.replace(/([^a-z])\s([^\-a-z])/gi,"$1,$2"),x=Number(u.split("(")[1].split(",")[0]),y=Number(u.split(",")[1].split(" ").join("").split(")").join("")),o=e[s].getAttribute("r"),m={x:x,y:y,r:parseFloat(o),id:s,sel:-1!==e[s].getAttribute("class").search("sel_primary")?!0:!1};a[s]=m,n[s]||(n[s]={x:x,y:y})}var c=0;return r&&clearInterval(r),r=setInterval(function(){t.animating=!0,c++>40&&(clearInterval(r),r=null,t.animating=!1),i()},40),t};var i=function(){for(var t=0;t<e.length;t++){for(var r=0;r<e.length;r++)t!=r&&s(a[t],a[r]);var i=e[t],l=a[t],u=n[t];Math.abs(l.x-u.x)>5&&(l.x+=.1*(u.x-l.x)),Math.abs(l.y-u.y)>5&&(l.y+=.1*(u.y-l.y)),i.setAttribute("transform","translate("+l.x+","+l.y+")"),i.setAttribute("r",l.r)}},s=function(t,r){if(x(t,r)){l.x=t.x-r.x,l.y=t.y-r.y;var a=l.x*l.x+l.y*l.y;l.normalize(),l.mult(.5*(t.r+r.r+5-Math.sqrt(a))),t.sel||(t.x+=l.x,t.y+=l.y),r.sel||(r.x-=l.x,r.x-=l.y)}},l={};l.normalize=function(){l.magnitude=Math.sqrt(l.x*l.x+l.y*l.y),l.x=l.x/l.magnitude,l.y=l.y/l.magnitude},l.mult=function(t){l.x*=t,l.y*=t};var u=function(t,r,a,n){var e=t-a,i=r-n;return Math.sqrt(e*e+i*i)},x=function(t,r){var a=u(t.x,t.y,r.x,r.y);return a<t.r+r.r+5};return t};