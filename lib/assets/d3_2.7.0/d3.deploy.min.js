...
var sm={};sm.packer=function(){var t={},r=0,n=[],a=[],e=[];t.elements=function(r){return arguments.length?(e=r,t):e},t.animating=!1,t.start=function(){n=[];for(var s=0;s<e.length;s++){var u=e[s].getAttribute("transform"),l=Number(u.split("(")[1].split(",")[0]),x=Number(u.split(",")[1].split(" ").join("").split(")").join("")),y=e[s].getAttribute("r"),o={x:l,y:x,r:parseFloat(y),id:s,sel:-1!==e[s].getAttribute("class").search("sel_primary")?!0:!1};n[s]=o,a[s]||(a[s]={x:l,y:x})}var m=0;return r&&clearInterval(r),r=setInterval(function(){t.animating=!0,m++>40&&(clearInterval(r),r=null,t.animating=!1),i()},40),t};var i=function(){for(var t=0;t<e.length;t++){for(var r=0;r<e.length;r++)t!=r&&s(n[t],n[r]);var i=e[t],u=n[t],l=a[t];Math.abs(u.x-l.x)>5&&(u.x+=.1*(l.x-u.x)),Math.abs(u.y-l.y)>5&&(u.y+=.1*(l.y-u.y)),i.setAttribute("transform","translate("+u.x+","+u.y+")"),i.setAttribute("r",u.r)}},s=function(t,r){if(x(t,r)){u.x=t.x-r.x,u.y=t.y-r.y;var n=u.x*u.x+u.y*u.y;u.normalize(),u.mult(.5*(t.r+r.r+5-Math.sqrt(n))),t.sel||(t.x+=u.x,t.y+=u.y),r.sel||(r.x-=u.x,r.x-=u.y)}},u={};u.normalize=function(){u.magnitude=Math.sqrt(u.x*u.x+u.y*u.y),u.x=u.x/u.magnitude,u.y=u.y/u.magnitude},u.mult=function(t){u.x*=t,u.y*=t};var l=function(t,r,n,a){var e=t-n,i=r-a;return Math.sqrt(e*e+i*i)},x=function(t,r){var n=l(t.x,t.y,r.x,r.y);return n<t.r+r.r+5};return t};