(function() {
    ...
    function g(a, b) {
        for (var c = a.features, e = 0, f = c.length; e < f; e++) d(c[e].geometry, b)
    }
    ...
    function p(b, c) {
        function r(b) {
            var c = Math.sin(p - (b *= p)) / q,
                ...
                j = c * h * f + d * n * l,
                m = c * i + d * o;
            return [Math.atan2(j, g) / a, Math.atan2(m, Math.sqrt(g * g + j * j)) / a]
        }
        var d = b[0] * a,
            e = Math.cos(d),
            f = Math.sin(d),
            ...
            n = Math.cos(m),
            o = Math.sin(m),
            p = r.d = Math.acos(Math.max(-1, Math.min(1, i * o + h * n * Math.cos(j - d)))),
            q = Math.sin(p);
        return r
    }
    d3.geo = {};
    ...
    d3.geo.azimuthal = function() {
        function j(c) {
            var g = c[0] * a - f,
                ...
                p, q = b === "stereographic" ? 1 / (1 + o) : b === "gnomonic" ? 1 / o : b === "equidistant" ? (p = Math.acos(o), p ? p / Math.sin(p) : 0) : b === "equalarea" ? Math.sqrt(2 / (1 + o)) : 1,
                r = q * m * l,
                s = q * (i * m * k - h * n);
        ...
        return j.invert = function(c) {
            var g = (c[0] - e[0]) / d,
                j = (c[1] - e[1]) / d,
                k = Math.sqrt(g * g + j * j),
                l = b === "stereographic" ? 2 * Math.atan(k) : b === "gnomonic" ? Math.atan(k) : b === "equidistant" ? k : b === "equalarea" ? 2 * Math.asin(.5 * k) : Math.asin(k),
                m = Math.sin(l),
                n = Math.cos(l);
            return [(f + Math.atan2(g * m, k * h * n + j * i * m)) / a, Math.asin(n * i - (k ? j * m * h / k : 0)) / a]
        }, j.mode = function(a) {
        ...
        return h.invert = function(e) {
            ...
            return arguments.length ? (g = 1 / Math.tan(f = b * a), h) : f / a
        }, h.origin = function(b) {
            return arguments.length ? (d = b[0] * a, e = b[1] * a, h) : [d / a, e / a]
        }, h.scale = function(a) {
        ...
        function f(b, e) {
            return typeof a == "function" && (d = c(a.apply(this, arguments))), h(b) || null
        }
        ...
        function k(a) {
            var b = d3.geom.polygon(a[0].map(e)),
                ...
                i = 0,
                j = a.length;
            while (++i < j) b = d3.geom.polygon(a[i].map(e)), c = b.area(), d = b.centroid(c < 0 ? (c *= -1, 1) : -1), f -= d[0], g -= d[1], h -= c;
            return [f, g, 6 * h]
        }
            ...
            l = f.centroid = b({
                ...
                MultiPolygon: function(a) {
                    var b = 0,
                        ...
                        h = -1,
                        i = c.length;
                    while (++h < i) d = k(c[h]), e += d[0], f += d[1], g += d[2];
                    return [e / g, f / g]
                }
            });
        return f.projection = function(a) {
            return e = a, f
        ...
        return d(a, function(a, d) {
            a < b && (b = a), a > e && (e = a), d < c && (c = d), d > f && (f = d)
        }), [
            [b, c],
            [e, f]
        ]
    ...
    d3.geo.circle = function() {
        ...
        function j(a) {
            var b = -1,
                ...
                d = [],
                g, h, i, j, l;
            while (++b < c) l = f.distance(i = a[b]), l < e ? (h && d.push(p(h, i)((j - e) / (j - l))), d.push(i), g = h = null) : (h = i, !g && d.length && (d.push(p(d[d.length - 1], h)((e - j) / (l - j))), g = h)), j = l;
            return h && d.length && (l = f.distance(i = d[0]), d.push(p(h, i)((j - e) / (j - l)))), k(d)
        }
        ...
        g.clip = function(a) {
            return f.source(typeof c == "function" ? c.apply(this, arguments) : c), i(a)
        };
        var i = b({
            FeatureCollection: function(a) {
