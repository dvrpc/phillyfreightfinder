    ...
    d3.csv('data/d3/port_diagram.csv', function(port_points) {
        d3.csv('data/d3/port_activity.csv', function(port_data) {
            d3.json("data/d3/river_diagram.js", function(json) {
                d3.csv("data/d3/river_labels.csv", function(river_labels){
                    ...
                    function add_labels(pl){                       
                        for (var i = 0; i < pl.length; i++) {
                            ...
                            var mi_river_labels = mi_river.append('g')
                                .attr('transform', 'translate(' + Math.round(lxly[0]) + ',' + Math.round(lxly[1]) + ')')
