    ...
    function load_data_download(){
        ...
        $.getJSON(dataURL, function(data) {
            for(var i = 0; i < data.length; i++){
                ...
                $('.dataDwnld-' + dwnID).append('<div class="right dl"><div class="noLink">Last Update: '+ dwnDate +'</div><div class="noLink">Download: </div><a class="dlLink" href="https://www.dvrpc.org/webmaps/phillyfreightfinder/data/download/shp/'+ dwnFile + '.zip" data-toggle="tooltip" title="Download Shapefile" >shp</a><a class="dlLink" href="https://www.dvrpc.org/webmaps/phillyfreightfinder/data/download/csv/'+ dwnFile + '.csv" data-toggle="tooltip" title="Download CSV" >csv</a><a class="dlLink" href="https://www.dvrpc.org/webmaps/phillyfreightfinder/data/download/json/'+ dwnFile + '.json" download="'+ dwnFile +'.json" data-toggle="tooltip" title="Download JSON" >json</a></div>' );
